...
export default class HomeCareScreen extends React.Component {
  _getRenderItemFunction = () =>
    ...
    const cellViews = rowData.item.map(item => (<TouchableOpacity
      key={item.id}
      style={styles.itemThreeContainer}
      onPress={() => this._openArticle(item)}
    >
      <View style={styles.itemThreeSubContainer}>
        <Image source={item.image} style={styles.itemThreeImage} />
    ...
    return (
      <View key={rowData.item[0].id} style={styles.itemThreeRow}>
        {cellViews}
      </View>
    );
  };
  ...
  renderRowThree = ({ item }) => (
    ...
    <View style={styles.itemOneContainer}>
      <View style={styles.itemOneImageContainer}>
        <Image style={styles.itemOneImage} source={item.image } />
      </View>
